...
from airflow_lappis.dags.data_ingest.programacao_financeira_siafi_ingest_dag import (
    dag_instance as dag,
)
...
@patch(
    "airflow_lappis.plugins.cliente_siafi.ClienteSiafi.consultar_programacao_financeira"
)
@patch("airflow_lappis.plugins.cliente_postgres.ClientPostgresDB.insert_data")
@patch(
    "airflow_lappis.plugins.cliente_postgres.ClientPostgresDB.get_programacao_financeira"
)
@patch(
    "airflow_lappis.dags.data_ingest.programacao_financeira_siafi_ingest_dag.get_postgres_conn"
)
