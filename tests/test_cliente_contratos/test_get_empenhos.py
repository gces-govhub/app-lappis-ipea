...
def test_get_empenhos_by_contrato_id_success(cliente_contratos):
    # Mockando a resposta esperada
    mock_response = Mock()
    mock_response.status_code = HTTPStatus.OK
    mock_response.json.return_value = [
        {"id": 1, "contrato_id": "98765", "valor": 500.0},
        {"id": 2, "contrato_id": "98765", "valor": 750.0},
    ]
    ...
    with patch(
        ...
        result = cliente_contratos.get_empenhos_by_contrato_id("98765")
        assert result == [
            {"id": 1, "contrato_id": "98765", "valor": 500.0},
            {"id": 2, "contrato_id": "98765", "valor": 750.0},
        ]
...
def test_get_empenhos_by_contrato_id_failure(cliente_contratos):
...
def test_get_empenhos_by_contrato_id_invalid_data(cliente_contratos):
